...
def imagemigration2():
	...
	cursor_slum.execute("select slum_id from ray_survey_slumsurveymetadata where survey_id=23;")
	...
	for i in fetch_slum_ids:
		...
		cursor_GeneralQ.execute("select id from  ray_survey_reporttemplatedesiredfact where  template_desiredfact_id=60 and desired_fact_group_id='34' and report_id=9;")
		...
		cursor_ToiletQ.execute("select id from  ray_survey_reporttemplatedesiredfact where template_desiredfact_id=60 and desired_fact_group_id='35' and report_id=9;")
		...
		cursor_waterQ.execute("select id from  ray_survey_reporttemplatedesiredfact where  template_desiredfact_id=60 and desired_fact_group_id='36' and report_id=9;")
...
"""
		...
		cursor_wasteQ.execute("select id from  ray_survey_reporttemplatedesiredfact where  template_desiredfact_id=60 and desired_fact_group_id='37' and report_id=9;")
		...
		cursor_roadQ.execute("select id from  ray_survey_reporttemplatedesiredfact where  template_desiredfact_id=60 and desired_fact_group_id='39' and report_id=9;")
		...
		cursor_drainageQ.execute("select id from  ray_survey_reporttemplatedesiredfact where  template_desiredfact_id=60 and desired_fact_group_id='40' and report_id=9;")
		...
		cursor_GutterQ.execute("select id from  ray_survey_reporttemplatedesiredfact where template_desiredfact_id=60 and desired_fact_group_id='41' and report_id=9;")
		...
		cursor_ApproxPQ.execute("select * from ray_survey_reporttemplatedesiredfact where template_desiredfact_id=13 and report_id=9;")
		...
		cursor_TratioQ.execute("select * from ray_survey_reporttemplatedesiredfact where template_desiredfact_id=18 and report_id=9 ;")
		...
		cursor_FCWCQ.execute("select * from ray_survey_reporttemplatedesiredfact where template_desiredfact_id=27 and report_id=9 ;")
		...
		cursor_PWIWCQ.execute("select * from ray_survey_reporttemplatedesiredfact where template_desiredfact_id=78 and report_id=9 ;")
		...
		cursor_TcostQ.execute("select * from ray_survey_reporttemplatedesiredfact where template_desiredfact_id=63 and report_id=9 ;")
		...
		cursor_BottomDownQ.execute("select id from ray_survey_reporttemplatedesiredfact where  template_desiredfact_id=62 and desired_fact_group_id='35' and report_id=9;")
		...
		BottomDownQ = psycopg2.connect(database='old1',user='postgres',password='softcorner',host='localhost',port='5432')
		cursor_BottomDownQ = BottomDownQ.cursor()
		cursor_BottomDownQ.execute("select id from ray_survey_reporttemplatedesiredfact where  template_desiredfact_id=62 and desired_fact_group_id='36' and report_id=9;")
		fetch_data1 = cursor_BottomDownQ.fetchone()
		BottomDownQ_id = fetch_data1[0]
		BottomDownA = psycopg2.connect(database='old1',user='postgres',password='softcorner',host='localhost',port='5432')
		cursor_BottomDownA = BottomDownA.cursor()
		...
		BottomDownQ = psycopg2.connect(database='old1',user='postgres',password='softcorner',host='localhost',port='5432')
		cursor_BottomDownQ = BottomDownQ.cursor()
		cursor_BottomDownQ.execute("select id from ray_survey_reporttemplatedesiredfact where  template_desiredfact_id=62 and desired_fact_group_id='37' and report_id=9;")
		fetch_data1 = cursor_BottomDownQ.fetchone()
		BottomDownQ_id = fetch_data1[0]
		BottomDownA = psycopg2.connect(database='old1',user='postgres',password='softcorner',host='localhost',port='5432')
		cursor_BottomDownA = BottomDownA.cursor()
		...
		BottomDownQ = psycopg2.connect(database='old1',user='postgres',password='softcorner',host='localhost',port='5432')
		cursor_BottomDownQ = BottomDownQ.cursor()
		cursor_BottomDownQ.execute("select id from ray_survey_reporttemplatedesiredfact where  template_desiredfact_id=62 and desired_fact_group_id='39' and report_id=9;")
		fetch_data1 = cursor_BottomDownQ.fetchone()
		BottomDownQ_id = fetch_data1[0]
		BottomDownA = psycopg2.connect(database='old1',user='postgres',password='softcorner',host='localhost',port='5432')
		cursor_BottomDownA = BottomDownA.cursor()
		...
		BottomDownQ = psycopg2.connect(database='old1',user='postgres',password='softcorner',host='localhost',port='5432')
		cursor_BottomDownQ = BottomDownQ.cursor()
		cursor_BottomDownQ.execute("select id from ray_survey_reporttemplatedesiredfact where  template_desiredfact_id=62 and desired_fact_group_id='40' and report_id=9;")
		fetch_data1 = cursor_BottomDownQ.fetchone()
		BottomDownQ_id = fetch_data1[0]
		BottomDownA = psycopg2.connect(database='old1',user='postgres',password='softcorner',host='localhost',port='5432')
		cursor_BottomDownA = BottomDownA.cursor()
		...
		BottomDownQ = psycopg2.connect(database='old1',user='postgres',password='softcorner',host='localhost',port='5432')
		cursor_BottomDownQ = BottomDownQ.cursor()
		cursor_BottomDownQ.execute("select id from ray_survey_reporttemplatedesiredfact where  template_desiredfact_id=62 and desired_fact_group_id='41' and report_id=9;")
		fetch_data1 = cursor_BottomDownQ.fetchone()
		BottomDownQ_id = fetch_data1[0]
		BottomDownA = psycopg2.connect(database='old1',user='postgres',password='softcorner',host='localhost',port='5432')
		cursor_BottomDownA = BottomDownA.cursor()
