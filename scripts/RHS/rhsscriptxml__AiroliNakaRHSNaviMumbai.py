...
"""
#my Machine
xform_id_string="azJwuSR3TutCcTwJn8aCDW_TeC16GO"
versioncode="vH6SV4LGHEJqu3AmEdzk73"
formhub_id="ca74803808ff48968c0ecb29f9c73e11"
userform_id="softcorner_azJwuSR3TutCcTwJn8aCDW_TeC16GO"
"""
...
folder = "/home/softcorner/ShelterAssociates/src/scripts/RHS/xmlfiles/AiroliNakaRHSNaviMumbai/"
...
def printdata():
    ...
    demo=0
    try:
        dataval=mongodb.instances.find({"_xform_id_string" :"aDX4TaDUDEebMv9ssd8tZw"})
        for data in dataval:
            count = count + 1
            listvar={}
            ...
            for key,value in data.items():
                if key == 'group_jg6ts57/city_name':#1
                    ...
                    listvar['group_ye18c77']['group_ud4em45']['what_is_the_full_name_of_the_family_head_']=str(specialcharremover(str(value)))
                elif key == 'group_xb9nq26/group_do8xg48/mobile_number':#9
                    listvar['group_ye18c77']['group_ud4em45']['mobile_number']={}
                    stringval = re.sub('[^A-Za-z0-9" "]+', '', value)
                    listvar['group_ye18c77']['group_ud4em45']['mobile_number']= stringval
