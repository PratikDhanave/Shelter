...
folder = "/home/softcorner/ShelterAssociates/src/scripts/RHS/xmlfiles/SainathwadiRHSNaviMumbai/"
...
def printdata():
    ...
    demo=0
    try:
        dataval=mongodb.instances.find({"_xform_id_string" :"aF9CAR386zSrmygaRF3B2a"})
        for data in dataval:
            count = count + 1
            listvar={}
