...
"""
xform_id_string="aG8SrJfKazUbY5TtpyKTu8_PJHi2P4"
versioncode="vRU8dbywUfTBWmFUejPmSt"
formhub_id="fce6bc09f36047049919e912a6e05722"
userform_id="softcorner_aG8SrJfKazUbY5TtpyKTu8_PJHi2P4"
"""
...
def printdata():
    ...
    demo=0
    try:
        dataval=mongodb.instances.find({"_xform_id_string" :"aSJM5YWy8LXcmHYL3ZMGgY","group_fz8ww97/Phone_Number": "8888321174"})#mongodb.instances.find({"_xform_id_string" :"aSJM5YWy8LXcmHYL3ZMGgY"})#
        for data in dataval:
            count = count + 1
