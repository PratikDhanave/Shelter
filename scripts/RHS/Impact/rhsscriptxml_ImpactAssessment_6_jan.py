...
def printdata():
    ...
    demo=0
    try:
        dataval=mongodb.instances_20161206.find({"_xform_id_string" :"aSJM5YWy8LXcmHYL3ZMGgY","group_fz8ww97/Phone_Number": "8888321174"})
        for data in dataval:
            count = count + 1
            ...
            xmldata=""
            xmldata = dict2xml({xform_id_string : jsonformat2(jsonvar)})
            xmlfinal=""
