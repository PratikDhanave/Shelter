...
client = MongoClient('mongodb://192.168.0.64:27018/')

#databse name
mongodb = client['dockerlive2016']
jsonvar={}
...
def printdata():
    ...
    demo=0
    try:
        dataval=mongodb.instances_20161206.find({"_xform_id_string" :"aSJM5YWy8LXcmHYL3ZMGgY"}).limit(1)
        for data in dataval:
            count = count + 1
            for key,value in data.items():
                try:
                    if key == 'group_fz8ww97/Name_of_City':#1
                        ...
                        for i in value:
                            for ke,val in i.items():
                                ...
                                if ke =='group_nw4qu40/Sex':#10
                                    jsonvar['group_nw4qu40/Sex']=str(specialcharremover(str(val)))
                                elif ke == 'group_nw4qu40/Marital_Status':#11
                                    jsonvar['group_nw4qu40/Marital_Status']=str(specialcharremover(str(val)))
                                elif ke == 'group_nw4qu40/Education':#12
                                    jsonvar['group_nw4qu40/Education']=str(specialcharremover(str(val)))
                                elif ke == 'group_nw4qu40/Occupation':#13
                                    jsonvar['group_nw4qu40/Occupation']=str(specialcharremover(str(val)))
                                elif ke == 'group_nw4qu40/Special_Characteristics':#14
                                    jsonvar['group_nw4qu40/Special_Characteristics']=str(specialcharremover(str(val)))
                                elif ke == 'group_nw4qu40/Name_of_the_family_Member':#8
                                    jsonvar['group_nw4qu40/Name_of_the_family_Member']=str(specialcharremover(str(val)))
                                elif ke == 'group_nw4qu40/Completed_Age_in_years':#9
                                    jsonvar['group_nw4qu40/Completed_Age_in_years']=str(specialcharremover(str(val)))
                        ...
                        for i in value:
                            for ke,val in i.items():
                                if ke == 'group_eh0at37/group_oq8lx49/Name_of_the_family_member_001':#82
                                    jsonvar['group_eh0at37/group_oq8lx49/Name_of_the_family_member_001']=str(specialcharremover(str(val)))
                                elif ke == 'group_eh0at37/group_oq8lx49/where_is_the_place_of_urinatio':#83
                                    jsonvar['group_eh0at37/group_oq8lx49/where_is_the_place_of_urinatio']=str(specialcharremover(str(val)))
                                elif ke == 'group_eh0at37/group_oq8lx49/Other_place_of_urination':#84
                                    jsonvar['group_eh0at37/group_oq8lx49/Other_place_of_urination']=str(specialcharremover(str(val)))
                                elif ke == 'group_eh0at37/group_oq8lx49/where_is_the_place_of_urinatio_001':#85
                                    jsonvar['group_eh0at37/group_oq8lx49/where_is_the_place_of_urinatio_001']=str(specialcharremover(str(val)))
                                elif ke == 'group_eh0at37/group_oq8lx49/Other_place_of_defecation':#85
                                    jsonvar['group_eh0at37/group_oq8lx49/Other_place_of_defecation']=str(specialcharremover(str(val)))
                                elif ke == 'group_eh0at37/group_oq8lx49/What_is_the_reason_of_choosing':#86
                                    jsonvar['group_eh0at37/group_oq8lx49/What_is_the_reason_of_choosing']=str(specialcharremover(str(val)))
                                elif ke == 'group_eh0at37/group_oq8lx49/Other_reason_for_choosing_curr':#87
                                    jsonvar['group_eh0at37/group_oq8lx49/Other_reason_for_choosing_curr']=str(specialcharremover(str(val)))
                                elif ke == 'group_eh0at37/group_oq8lx49/What_are_the_problems_associat':#88
                                    jsonvar['group_eh0at37/group_oq8lx49/What_are_the_problems_associat']=str(specialcharremover(str(val)))
                                elif ke == 'group_eh0at37/group_oq8lx49/Other_Problem_associated_with_':#89
                                    jsonvar['group_eh0at37/group_oq8lx49/Other_Problem_associated_with_']=str(specialcharremover(str(val)))
                                elif ke == 'group_eh0at37/group_oq8lx49/If_children_elderly_defecating':#90
                                    jsonvar['group_eh0at37/group_oq8lx49/If_children_elderly_defecating']=str(specialcharremover(str(val)))
                                elif ke == 'group_eh0at37/group_oq8lx49/What_are_the_problems_associat_001':#91
                                    jsonvar['group_eh0at37/group_oq8lx49/What_are_the_problems_associat_001']=str(specialcharremover(str(val)))
                                elif ke == 'group_eh0at37/group_oq8lx49/Other_problems_associated_with':#92
                                    jsonvar['group_eh0at37/group_oq8lx49/Other_problems_associated_with']=str(specialcharremover(str(val)))
                        ...
                        for i in value:
                            for ke,val in i.items():
                                if ke == 'group_mw2gr61/Name_of_family_member':#119
                                    jsonvar['group_mw2gr61/Name_of_family_member']=str(specialcharremover(str(val)))
                                elif ke == 'group_mw2gr61/Did_Name_suffer_from_any_o':#120
                                    jsonvar['group_mw2gr61/Did_Name_suffer_from_any_o']=str(specialcharremover(str(val)))
                                elif ke == 'group_mw2gr61/Other_illness':#121
                                    jsonvar['group_mw2gr61/Other_illness']=str(specialcharremover(str(val)))
                                elif ke == 'group_mw2gr61/Has_Name_sought_treatment_fo':#122
                                    jsonvar['group_mw2gr61/Has_Name_sought_treatment_fo']=str(specialcharremover(str(val)))
                                elif ke == 'group_mw2gr61/What_are_the_expenses_for_the_':#123
                                    jsonvar['group_mw2gr61/What_are_the_expenses_for_the_']=str(specialcharremover(str(val)))
                    elif key == 'group_mw6ct68':
                        for i in value:
                            for ke,val in i.items():
                                if ke == 'group_mw6ct68/Name_of_Family_member_002':#124
                                    jsonvar['group_mw6ct68/Name_of_Family_member_002']=str(specialcharremover(str(val)))
                                elif ke == 'group_mw6ct68/Did_you_suffer_from_any_of_the':#125
                                    jsonvar['group_mw6ct68/Did_you_suffer_from_any_of_the']=str(specialcharremover(str(val)))
                                elif ke == 'group_mw6ct68/Did_you_suffer_from_any_of_the_001':#126
                                    jsonvar['group_mw6ct68/Did_you_suffer_from_any_of_the_001']=str(specialcharremover(str(val)))
                                elif ke == 'group_mw6ct68/Did_you_suffer_from_any_of_the_002':#127
                                    jsonvar['group_mw6ct68/Did_you_suffer_from_any_of_the_002']=str(specialcharremover(str(val)))
                                elif ke == 'group_mw6ct68/Do_you_think_extra_cleanliness':#128
                                    jsonvar['group_mw6ct68/Do_you_think_extra_cleanliness']=str(specialcharremover(str(val)))
                                elif ke == 'group_mw6ct68/During_menstrual_period_how_m':#129
                                    jsonvar['group_mw6ct68/During_menstrual_period_how_m']=str(specialcharremover(str(val)))
                                elif ke == 'group_mw6ct68/How_often_have_you_washed_your':#130
                                    jsonvar['group_mw6ct68/How_often_have_you_washed_your']=str(specialcharremover(str(val)))
                        ...
                        for i in value:
                            for ke,val in i.items():
                                if ke == 'group_qc6ug62/group_om1sb12/Name_of_family_member_001':#136
                                    jsonvar['group_qc6ug62/group_om1sb12/Name_of_family_member_001']=str(specialcharremover(str(val)))
                                elif ke == 'group_qc6ug62/group_om1sb12/Teasing':#137
                                    jsonvar['group_qc6ug62/group_om1sb12/Teasing']=str(specialcharremover(str(val)))
                                elif ke == 'group_qc6ug62/group_om1sb12/Physical_abuse':#138
                                    jsonvar['group_qc6ug62/group_om1sb12/Physical_abuse']=str(specialcharremover(str(val)))
                                elif ke == 'group_qc6ug62/group_om1sb12/Animal_bite':#139
                                    jsonvar['group_qc6ug62/group_om1sb12/Animal_bite']=str(specialcharremover(str(val)))
                                elif ke == 'group_qc6ug62/group_om1sb12/Insect_bite':#140
                                    jsonvar['group_qc6ug62/group_om1sb12/Insect_bite']=str(specialcharremover(str(val)))
                                elif ke == 'group_qc6ug62/group_om1sb12/How_safe_do_you_feel_while_usi':#141
                                    jsonvar['group_qc6ug62/group_om1sb12/How_safe_do_you_feel_while_usi']=str(specialcharremover(str(val)))
                                elif ke == 'group_qc6ug62/group_om1sb12/How_safe_do_you_feel_while_def':#142
                                    jsonvar['group_qc6ug62/group_om1sb12/How_safe_do_you_feel_while_def']=str(specialcharremover(str(val)))
                                elif ke == 'group_qc6ug62/group_om1sb12/How_safe_do_you_feel_while_app':#143
                                    jsonvar['group_qc6ug62/group_om1sb12/How_safe_do_you_feel_while_app']=str(specialcharremover(str(val)))
                                elif ke == 'group_qc6ug62/group_om1sb12/How_would_you_rate_the_privacy':#144
                                    jsonvar['group_qc6ug62/group_om1sb12/How_would_you_rate_the_privacy']=str(specialcharremover(str(val)))
                                elif ke == 'group_qc6ug62/group_om1sb12/How_would_you_rate_the_privacy_001':#145
                                    jsonvar['group_qc6ug62/group_om1sb12/How_would_you_rate_the_privacy_001']=str(specialcharremover(str(val)))
                                elif ke == 'group_qc6ug62/group_om1sb12/How_would_you_rate_the_distanc':#146
                                    jsonvar['group_qc6ug62/group_om1sb12/How_would_you_rate_the_distanc']=str(specialcharremover(str(val)))
            ...
            filename=str("Impactv2_"+city_id+"_"+admin_no+"_"+slum_no+"_"+house_no+"_"+ str(id_id)+".xml")
