...
"""
#Sitaram machine
xform_id_string="aC8tegb87vQ9nL3jkHF65d"
versioncode="vLMEcnHrbMQXo7aL3rzrsG"
formhub_id="83513e960be049dd9d1392cc3f25ab80"
userform_id="amar_aC8tegb87vQ9nL3jkHF65d"
"""
                    ...
                    for i in value:
                        ...
                        for ke,val in i.items():
                            if ke == 'group_eh0at37/group_oq8lx49/Name_of_the_family_member_001':#82#
                                ...
                                print "****************************"
                                print val
                                arraydict['where_is_the_place_of_urinatio']=str("B")
                                ...
                                arraydict['where_is_the_place_of_urinatio_001']=str(val)
...
if key == 'group_wd4ew27/group_tc8ri87/Material_used_for_roof_Observ':#30
    ...
    jsonvar['group_tx1ao07/_Observe_and_write_Please_sho']=str(specialcharremover(str(value)))
elif key == 'group_tx1ao07/With_what_do_you_wash_your_ha':#114
