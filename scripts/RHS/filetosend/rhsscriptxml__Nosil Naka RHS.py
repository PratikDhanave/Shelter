...
city_id=""
id_id = " "
folder = "/home/softcorner/ShelterAssociates/src/scripts/RHS/xmlfiles/NosilNaka/"
...
def printdata():
    ...
    demo=0
    try:
        dataval=mongodb.instances.find({"_xform_id_string" :"aTVQ9kgnzcn9jh956UYPey"})
        for data in dataval:
            listvar={}
            count = count + 1
            ...
            for key,value in data.items():
                if key == 'group_jg6ts57/city_name':#1
                    ...
                    slum_no= specialcharremover(str(value))
                    ...
                    print "what_is_the_full_name_of_the_f :" + value
                    ...
                    print "type_of_structure_of_the_house :" + value
                    ...
                    print "no_of_family_fembers" + value
                    ...
                    print "house_area_in_sq_ft :" +value
                    ...
                    print "current_place_of_defecation_t" + value
                    if value == '01':
                    ...
                    if value == '09':
                        print value
                        listvar['group_ye18c77']['group_yw8pj39']['where_the_individual_toilet_is_connected_to_']=str("08")
                    else:
                    ...
                    if checker == '01':
                        listvar['group_ye18c77']['group_yw8pj39']['facility_of_waste_collection']=str(specialcharremover(str("01")))
                        print "03"
                    elif checker == '02':
                        listvar['group_ye18c77']['group_yw8pj39']['facility_of_waste_collection']=str(specialcharremover(str("02")))
                        print "02"
                    elif checker =="03":
                        listvar['group_ye18c77']['group_yw8pj39']['facility_of_waste_collection']=str(specialcharremover(str("03")))
                        print "03"
                    elif checker == '04':
                        listvar['group_ye18c77']['group_yw8pj39']['facility_of_waste_collection']=str(specialcharremover(str("03")))
                        print "04"
                    elif checker == '05':
                        listvar['group_ye18c77']['group_yw8pj39']['facility_of_waste_collection']=str(specialcharremover(str("04")))
                        print "04"
                    elif checker =="06":
                        listvar['group_ye18c77']['group_yw8pj39']['facility_of_waste_collection']=str(specialcharremover(str("05")))
                        print "05"
                    elif checker == '07':
                        listvar['group_ye18c77']['group_yw8pj39']['facility_of_waste_collection']=str(specialcharremover(str("06")))
                        print "06"
                    elif checker =="08":
                        print "Hiiiiiiiiiiiiiiiiiiiiiiiiiiii"
                        listvar['group_ye18c77']['group_yw8pj39']['facility_of_waste_collection']=str(specialcharremover(str("07")))
                elif key == 'group_xb9nq26/group_io6zh11/interested_in_individual_toile':#21
                    print "interested_in_individual_toile"
                    ...
                    listvar['group_ye18c77']['group_yw8pj39']['How_many_installements_have_yo']=str(specialcharremover(str(value)))
