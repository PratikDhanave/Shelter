...
folder = "/home/softcorner/ShelterAssociates/src/scripts/RHS/xmlfiles/SamtaNagarRHSNaviMumbai/"
...
def printdata():
    ...
    demo=0
    try:
        dataval=mongodb.instances.find({"_xform_id_string" :"ahUrmUnnVZG7ja9MbUBESj"})
        listvar={}
        for data in dataval:
            count = count + 1
            ...
            for key,value in data.items():
                if key == 'group_jg6ts57/city_name':#1
                    listvar['group_ce0hf58'].update({'city':value})
