...
folder = "/home/softcorner/ShelterAssociates/src/scripts/RHS/xmlfiles/SanjayGandhiNagarRHSNaviMumbai/"
...
def printdata():
    ...
    listvar={}
    try:
        dataval=mongodb.instances.find({"_xform_id_string" :"ajH7Pcg2vjtmKmpY8JfW4D"})
        for data in dataval:
            count = count + 1
            listvar={}
