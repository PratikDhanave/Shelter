...
folder = "/home/softcorner/ShelterAssociates/src/scripts/RHS/xmlfiles/BalajiNagarRHSPCMC/"
...
def printdata():
    ...
    demo=0
    try:
        dataval=mongodb.instances.find({"_xform_id_string" :"aLBQuFsEUfh4VBV2sfKSmA"})
        for data in dataval:
            count = count + 1
            listvar={}
