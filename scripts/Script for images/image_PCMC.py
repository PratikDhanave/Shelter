...
def imagemigration2():
	...
	for i in fetch_slum_ids:
		...
		cursor_BottomDownQ.execute("select id from ray_survey_reporttemplatedesiredfact where  template_desiredfact_id=62 and desired_fact_group_id='35' and report_id=8;")
		...
		BottomDownQ = psycopg2.connect(database='old1',user='postgres',password='softcorner',host='localhost',port='5432')
		cursor_BottomDownQ = BottomDownQ.cursor()
		cursor_BottomDownQ.execute("select id from ray_survey_reporttemplatedesiredfact where  template_desiredfact_id=62 and desired_fact_group_id='36' and report_id=8;")
		fetch_data1 = cursor_BottomDownQ.fetchone()
		BottomDownQ_id = fetch_data1[0]
		BottomDownA = psycopg2.connect(database='old1',user='postgres',password='softcorner',host='localhost',port='5432')
		cursor_BottomDownA = BottomDownA.cursor()
		...
		BottomDownQ = psycopg2.connect(database='old1',user='postgres',password='softcorner',host='localhost',port='5432')
		cursor_BottomDownQ = BottomDownQ.cursor()
		cursor_BottomDownQ.execute("select id from ray_survey_reporttemplatedesiredfact where  template_desiredfact_id=62 and desired_fact_group_id='37' and report_id=8;")
		fetch_data1 = cursor_BottomDownQ.fetchone()
		BottomDownQ_id = fetch_data1[0]
		BottomDownA = psycopg2.connect(database='old1',user='postgres',password='softcorner',host='localhost',port='5432')
		cursor_BottomDownA = BottomDownA.cursor()
		...
		BottomDownQ = psycopg2.connect(database='old1',user='postgres',password='softcorner',host='localhost',port='5432')
		cursor_BottomDownQ = BottomDownQ.cursor()
		cursor_BottomDownQ.execute("select id from ray_survey_reporttemplatedesiredfact where  template_desiredfact_id=62 and desired_fact_group_id='39' and report_id=8;")
		fetch_data1 = cursor_BottomDownQ.fetchone()
		BottomDownQ_id = fetch_data1[0]
		BottomDownA = psycopg2.connect(database='old1',user='postgres',password='softcorner',host='localhost',port='5432')
		cursor_BottomDownA = BottomDownA.cursor()
		...
		BottomDownQ = psycopg2.connect(database='old1',user='postgres',password='softcorner',host='localhost',port='5432')
		cursor_BottomDownQ = BottomDownQ.cursor()
		cursor_BottomDownQ.execute("select id from ray_survey_reporttemplatedesiredfact where  template_desiredfact_id=62 and desired_fact_group_id='40' and report_id=8;")
		fetch_data1 = cursor_BottomDownQ.fetchone()
		BottomDownQ_id = fetch_data1[0]
		BottomDownA = psycopg2.connect(database='old1',user='postgres',password='softcorner',host='localhost',port='5432')
		cursor_BottomDownA = BottomDownA.cursor()
