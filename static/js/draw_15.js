...
jQuery(document).ready(function(){
   ...
   jQuery("input[name='_save'], input[name='_continue'], input[name='_addanother']").click(function(){
    ...
    jQuery("#id_city, #id_administrative_ward, #id_electoral_ward").on('change',function()
     {  
        laodmap();      
    });
});
